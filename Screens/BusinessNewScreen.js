...
export default class BusinessNewScreen extends React.Component{
  constructor(){
    super();
    this.state = {
      news : '',
  ...
  getNews = async () => {
    var url = 'https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=57157c4a2aae425cb961b45d2cec1054';
    return fetch(url)
