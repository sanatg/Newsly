...
export default class NewsScreen extends React.Component{
  ...
  getNews = async () => {
    var url = 'https://newsapi.org/v2/top-headlines?sources=techcrunch&apiKey=57157c4a2aae425cb961b45d2cec1054';
    return fetch(url)
...
<Text style = {{fontSize:30,textAlign:'center',justifyContent:'center',marginTop:300}}>Getting Your Tech Dose...</Text>
</View>
